...
import androidIosService from '../services/androidIos.service'
...
//贷款有订单--审核中,拒绝,失败,应还款,赵大宝还款，第三方还款
...
const should_repay_ZhaoDaBao_hasorder = r => require.ensure([], () => r(require('../view/home/loan/hasorder/should_repay_ZhaoDaBao_hasorder.vue')), 'should_repay_ZhaoDaBao_hasorder')
...
// KSP还款页 点击的Market Transfer  进入详情页
const marketDeatails = r => require.ensure([], () => r(require('../view/home/loan/hasorder/marketDeatails.vue')), 'marketDeatails')
// KSP还款页 点击的Bank Transfer  进入详情页
const bankDetails = r => require.ensure([], () => r(require('../view/home/loan/hasorder/bankDetails.vue')), 'bankDetails')

// KSP还款页-->点击Bank Transfer-->点击详情页进入二级详情页
const repayPage_bankInfo = r => require.ensure([], () => r(require('../view/home/loan/hasorder/repayPage_bankInfo.vue')), 'repayPage_bankInfo')
...
const routes = [
  ...
  {
    path: '/shouldRepayZhaoDaBaohasorder',//赵大宝还款(有订单))
    name: 'shouldRepayZhaoDaBaohasorder',
    meta: {
      requireAuth: true,
    },
    component: should_repay_ZhaoDaBao_hasorder,
  },
  {
  ...
  {
    path: '/marketDeatails',//KSP还款页 点击的Market Transfer  进入详情页
    name: 'marketDeatails',
    meta: {
      requireAuth: true,
    },
    component: marketDeatails,
  },
  {
    path: '/bankDetails',//KSP还款页 点击的Bank Transfer  进入详情页
    name: 'bankDetails',
    meta: {
      requireAuth: true,
    },
  ...
  {
    path: '/repayPage_bankInfo',//KSP还款页 点击的Bank Transfer  进入详情页 点击详情页进入二级详情页
    name: 'repayPage_bankInfo',
    meta: {
      requireAuth: true,
    },
    component: repayPage_bankInfo,
  },
  {
